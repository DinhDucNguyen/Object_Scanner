...
data class ListeningQuestion(
    val progressId: Int,
    val correctAnswer: String // English (to be spoken by TTS)
)

data class ListeningAnswerResult(
    val isCorrect: Boolean,
    val userAnswer: String,
    val correctAnswer: String
)

class ListeningTestViewModel(application: Application) : AndroidViewModel(application) {

    private val repo = (application as ObjectLanguageApp).repository

    private val _currentQuestion = MutableLiveData<ListeningQuestion?>()
    val currentQuestion: LiveData<ListeningQuestion?> = _currentQuestion

    private val _answerResult = MutableLiveData<ListeningAnswerResult?>()
    val answerResult: LiveData<ListeningAnswerResult?> = _answerResult
    ...
    fun submitAnswer(userAnswer: String) {
        ...
        // Show answer result
        _answerResult.value = ListeningAnswerResult(
            isCorrect = isCorrect,
